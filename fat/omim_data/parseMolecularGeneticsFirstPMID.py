...
if __name__ == "__main__":
    ...
    for ref in refs:
        ...
        refNumberToPmid[referenceNumber] = ''.join(pubmedIDs[0].itertext())
    for refNumber in references:
        if refNumber in refNumberToPmid:
            print("%s\t%s" % (omim_id, refNumberToPmid[refNumber]))
            break
